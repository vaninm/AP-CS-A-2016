 ...
 * @version 2.0
 * 
 * Added a response to pressed space key
 * 
 */
...
public class BlockDisplay extends JComponent implements KeyListener
{
    ...
    private static final Color SCORE = Color.CYAN;
    ...
    /**
     * Sets the colors for the given graphic
     * @param g: the graphic to be colored
     */
    public void paintComponent(Graphics g)
    {
        ...
        g.fillRect(0, 0, BLOCKSIZE * board.getNumCols() + OUTLINE, 4);
    }
    ...
    /**
     * Responds to a key being pressed. Depending on which arrow is pressed, it calls the 
     * corresponding method in the listener class
     * @param e: the event 
     */
    ...
    /**
     * Sets the listeener to be called by the BlockDisplay class
     * @param listener: the listener to be called by the BlockDisplay class
     */
